...
void mat_mat_blocked_interchanged_64(DATA A[SIZE][SIZE], DATA B[SIZE][SIZE], DATA C[SIZE][SIZE])
{
...
int main()
{
    ...
    mat_mat_blocked_interchanged_64(A, B, C4);

    after = seconds();
    double blocked_64 = after - before;
    printf("Blocked Interchange Optimization, size 64 Time:%f\n", blocked_64);

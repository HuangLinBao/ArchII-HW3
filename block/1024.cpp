...
void mat_mat_blocked_32(DATA A[SIZE][SIZE], DATA B[SIZE][SIZE], DATA C[SIZE][SIZE])
{
...
void mat_mat_blocked_64(DATA A[SIZE][SIZE], DATA B[SIZE][SIZE], DATA C[SIZE][SIZE])
{
    const int BLOCK_SIZE = 64; // Adjust block size based on cache size and data access patterns
...
void mat_mat_blocked_16(DATA A[SIZE][SIZE], DATA B[SIZE][SIZE], DATA C[SIZE][SIZE])
{
...
int main()
{
    ...
    mat_mat_blocked_16(A, B, C2);

    after = seconds();

    double blocked_16 = after - before;
    printf("Blocked Optimization, size 16 Time:%f\n", blocked_16);
    ...
    mat_mat_blocked_32(A, B, C3);

    after = seconds();
    double blocked_32 = after - before;

    printf("Blocked Optimization, size 32 Time:%f\n", blocked_32);
    ...
    mat_mat_blocked_64(A, B, C4);

    after = seconds();
    double blocked_64 = after - before;
    printf("Blocked Optimization, size 64 Time:%f\n", blocked_64);

    printf("verification:%d\n\n", compare(C, C4));
    printf("improvement:%f\n", conventionalTime / blocked_64);
